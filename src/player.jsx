...
let PacketBuffer = class {
    ...
    parseMessageData(timing, in_txt, out_txt) {
        ...
        for (;;) {
            ...
            if (matches === null) {
                this.reportError("invalid timing string");
            } else if (matches[0] == "") {
                break;
            }
            ...
            case "[":
                ...
                if (s.length != x) {
                    this.reportError("timing entry out of input bounds");
                }
                io.push(s);
                break;
            ...
            case "]":
                ...
                if (s.length != x) {
                    this.reportError("timing entry out of output bounds");
                }
                io.push(s);
                break;
                /* Window */
        ...
        if (in_txt_pos < in_txt.length) {
            this.reportError("extra input present");
        }
        if (out_txt_pos < out_txt.length) {
            this.reportError("extra output present");
        }
